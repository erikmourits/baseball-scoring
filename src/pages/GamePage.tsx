        ...
        <div className="flex items-center justify-between px-2">
          ...
          <div className="text-center min-w-[80px]">
            <div className="flex items-center justify-center gap-1 mb-0.5">
              ...
              <button onClick={() => { setSubDefaultTeamId(game.awayTeamId ?? ''); setShowSub(true) }} className="text-white/50 hover:text-white text-base leading-none px-1 py-0.5 transition-colors" title={t('game.sub')}>⇄</button>
            </div>
          ...
          <div className="text-center min-w-[80px]">
            <div className="flex items-center justify-center gap-1 mb-0.5">
              ...
              <button onClick={() => { setSubDefaultTeamId(game.homeTeamId ?? ''); setShowSub(true) }} className="text-white/50 hover:text-white text-base leading-none px-1 py-0.5 transition-colors" title={t('game.sub')}>⇄</button>
            </div>
