...
export function KNBSBScorecard({ data }: Props) {
        ...
        <table className="border-collapse text-xs whitespace-nowrap">
          <thead>
            <tr className="bg-gray-50 dark:bg-gray-800">
              <th className="sticky left-0 z-10 bg-gray-50 dark:bg-gray-800 px-1 py-1.5 text-center font-semibold text-gray-500 dark:text-gray-400 min-w-[28px] border-r border-gray-200 dark:border-gray-700">{t('scorecardView.pos')}</th>
              <th className="sticky left-7 z-10 bg-gray-50 dark:bg-gray-800 px-2 py-1.5 text-left font-semibold text-gray-500 dark:text-gray-400 min-w-[110px]">{t('gameSummary.player')}</th>
              <th className="sticky left-[146px] z-10 bg-gray-50 dark:bg-gray-800 px-1 py-1.5 text-center font-semibold text-gray-500 dark:text-gray-400 min-w-[24px] border-r border-gray-200 dark:border-gray-700">#</th>
              {inningNums.map(n => (
            ...
            {lineup.map((entry, idx) => {
              ...
              return (
                <tr key={entry.playerId} className={rowBg}>
                  <td className={`sticky left-0 z-10 ${rowBg} px-1 py-0.5 text-center text-gray-500 dark:text-gray-400 border-r border-gray-200 dark:border-gray-700`}>
                    {entry.fieldingPosition ?? '—'}
                  </td>
                  <td className={`sticky left-7 z-10 ${rowBg} px-2 py-0.5 font-medium truncate max-w-[110px]`}>
                    {player?.name ?? '—'}
                  </td>
                  <td className={`sticky left-[146px] z-10 ${rowBg} px-1 py-0.5 text-center text-gray-400 dark:text-gray-500 border-r border-gray-200 dark:border-gray-700`}>
                    {player?.jerseyNumber ?? ''}
                  </td>
                  {inningNums.map(n => (
